...
<section className="relative container">
  <div className="mx-auto max-w-7xl py-16 ltr">
    <div className="text-[#268B43] text-[16px] capitalize font-bold mb-[2%]">~ &nbsp; {t('whoweare.text1')}</div>
    <div className="pt-[15px] pb-[15px] rounded-[8px]">
      <div className="flex flex-col lg:flex-row md:flex-row  items-center justify-between">
        <div className="ltr mb-[10px] lg:mb-[0px] md:mb-[10px] flex items-center justify-between">
          <div className="flex flex-col w-[100%] lg-[50%] md:w-[50%] p-[12px]">
          <div className="text-[#000000] text-[40px] font-bold">{t('whoweare.text2')}</div>
          <div className="text-[#000000] text-[16px] font-medium">{t('whoweare.text3')}</div>
          ...
          <div className="flex flex-col p-[10px] w-[250px]">
            <div className="text-[#000000] text-[16px] font-bold">{t('whoweare.text4')}</div>
            <div className="text-[#000000] text-[14px] font-medium">{t('whoweare.text5')}</div>
          </div>
          ...
          <div className="flex flex-col p-[10px] w-[250px]">
           ...
           <RouterLink to={`/${i18n.language}/aboutUs`} className="flex items-center justify-center uppercase w-[80px] h-[30px] rounded-[4px] bg-[#1A4FC6] text-[#fff] text-[14px] font-medium">
                    <span className=" text-[#fff]">{t('more')}</span>
          </RouterLink>
          </div>
          <div className="w-[100%] lg-[50%] md:w-[50%] relative">
